      ...
      <div className="hrms-header" style={{ marginBottom: '24px', alignItems: 'flex-start', justifyContent: 'space-between' }}>
        <div>
          ...
          <p style={{ margin: '4px 0 0 0', fontSize: '14px', color: '#64748B' }}>
            Manage identity proofs, contracts, salary slips, and compliance records for employees.
          </p>
        </div>
              ...
              <div style={{ padding: '24px 28px', display: 'flex', flexDirection: 'column', gap: '18px', overflowY: 'auto', flex: 1 }}>
                ...
                <div className="hrms-input-group">
                  ...
                  <div style={{
                    ...
                    />
                    <label htmlFor="employee-doc-file-input" style={{ cursor: 'pointer', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px' }}>
