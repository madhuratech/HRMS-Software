...
const DEPT_PIE = [
  { name: 'Engineering', value: 72, percent: '29.03%', color: '#2563EB' },
  { name: 'Human Resources', value: 32, percent: '12.90%', color: '#60A5FA' },
  { name: 'Sales & Marketing', value: 42, percent: '16.94%', color: '#38BDF8' },
  { name: 'Finance', value: 28, percent: '11.29%', color: '#818CF8' },
  { name: 'Operations', value: 36, percent: '14.52%', color: '#A78BFA' },
  { name: 'IT', value: 20, percent: '8.06%', color: '#F59E0B' },
  { name: 'Support', value: 18, percent: '7.26%', color: '#9CA3AF' },
];
...
const GENDER_PIE = [
  { name: 'Male', value: 156, percent: '62.90%', color: '#2563EB' },
  { name: 'Female', value: 92, percent: '37.10%', color: '#EC4899' },
];

const EMP_SUMMARY = [
  { dept: 'Engineering', total: 72, active: 63, leave: 3, joiners: 5, resigned: 1, age: 31.2, exp: '4.2 Yrs' },
  ...
  { dept: 'Operations', total: 36, active: 31, leave: 2, joiners: 2, resigned: 0, age: 32.3, exp: '4.0 Yrs' },
  { dept: 'IT', total: 20, active: 18, leave: 1, joiners: 2, resigned: 1, age: 30.7, exp: '4.0 Yrs' },
  { dept: 'Support', total: 18, active: 13, leave: 1, joiners: 1, resigned: 2, age: 28.9, exp: '3.2 Yrs' },
];
  ...
  return (
    <div style={{ fontFamily: "'Inter', -apple-system, sans-serif", width: '100%', boxSizing: 'border-box' }}>
      ...
      <div style={{ display: 'flex', gap: 16, marginBottom: 20, flexWrap: 'wrap' }}>
        <KpiCard label="Total Employees" value="248" subtext="8 (3.33%) vs last month" up iconBg="#DBEAFE" iconColor="#2563EB" icon={Users} />
        <KpiCard label="Active Employees" value="214" subtext="12 (5.94%) vs last month" up iconBg="#DCFCE7" iconColor="#16A34A" icon={UserCheck} />
        <KpiCard label="On Leave" value="18" subtext="2 (10%) vs last month" up={false} iconBg="#FEF3C7" iconColor="#D97706" icon={Clock} />
        <KpiCard label="New Joiners" value="16" subtext="4 (33.33%) vs last month" up iconBg="#DBEAFE" iconColor="#2563EB" icon={Users} />
        <KpiCard label="Resigned" value="5" subtext="1 (16.67%) vs last month" up={false} iconBg="#FEE2E2" iconColor="#DC2626" icon={UserX} />
      </div>
          ...
          <div style={{ display: 'flex', alignItems: 'center' }}>
            <div style={{ width: 170, height: 170, position: 'relative', flexShrink: 0 }}>
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie data={DEPT_PIE} cx="50%" cy="50%" innerRadius={50} outerRadius={72} dataKey="value" stroke="none">
          ...
          <div style={{ height: 210 }}>
            <ResponsiveContainer width="100%" height="100%">
              <BarChart data={AGE_BAR} margin={{ top: 10, right: 10, left: -20, bottom: 0 }}>
                ...
                <YAxis tick={{ fill: '#6B7280', fontSize: 11 }} axisLine={false} tickLine={false} domain={[0, 80]} ticks={[0, 20, 40, 60, 80]} />
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 300px', gap: 20 }}>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse' }}>
              ...
              <tbody>
                ...
                <tr style={{ height: 44, fontWeight: 700, background: '#FAFAFA', borderTop: '1px solid #E5E7EB' }}>
                  ...
                  <td style={{ padding: '0 14px', fontSize: 12, color: '#111827' }}>11</td>
                  <td style={{ padding: '0 14px', fontSize: 12, color: '#111827' }}>16</td>
                  <td style={{ padding: '0 14px', fontSize: 12, color: '#111827' }}>5</td>
                  <td style={{ padding: '0 14px', fontSize: 12, color: '#111827' }}>32.4</td>
                  <td style={{ padding: '0 14px', fontSize: 12, color: '#111827' }}>4.5 Yrs</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div style={{ background: '#FFF', borderRadius: 14, border: '1px solid #E5E7EB', padding: 20, boxShadow: '0 2px 8px rgba(15,23,42,.05)' }}>
          ...
          <div style={{ width: '100%', height: 160, position: 'relative' }}>
            <ResponsiveContainer width="100%" height="100%">
              <PieChart>
                <Pie data={GENDER_PIE} cx="50%" cy="50%" innerRadius={50} outerRadius={72} dataKey="value" stroke="none">
                  {GENDER_PIE.map((e, i) => <Cell key={i} fill={e.color} />)}
                </Pie>
                <Tooltip />
              </PieChart>
            </ResponsiveContainer>
