...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: '#FFF', borderRadius: 16, marginBottom: 16, borderWidth: 1, borderColor: '#F5F3FF', shadowColor: '#8B5CF6', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.04, shadowRadius: 12, elevation: 2 },
  ...
  shiftName: { fontSize: 13, color: '#64748B', marginTop: 2, fontWeight: '500' },
