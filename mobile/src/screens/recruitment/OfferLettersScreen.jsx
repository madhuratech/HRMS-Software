...
export default function OfferLettersScreen({ navigation }) {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      const res = await apiClient.get('/recruitment/offers');
      ...
      console.error('Error fetching OfferLetters:', err);
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        <View>
          ...
          <Text style={styles.headerSubtitle}>Generate and track offers</Text>
        </View>
