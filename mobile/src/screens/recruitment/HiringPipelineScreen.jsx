...
export default function HiringPipelineScreen({ navigation }) {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      const res = await apiClient.get('/recruitment/pipeline');
      ...
      console.error('Error fetching HiringPipeline:', err);
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        <View>
          ...
          <Text style={styles.headerSubtitle}>View hiring stages</Text>
        </View>
