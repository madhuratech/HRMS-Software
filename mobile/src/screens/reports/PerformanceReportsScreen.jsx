...
import { Download, Star, TrendingUp, TrendingDown, Target } from 'lucide-react-native';
import { LinearGradient } from 'expo-linear-gradient';

const SUMMARY_DATA = [
  { id: 1, dept: 'Engineering', avgRating: '4.2/5', completed: 45, pending: 2 },
  { id: 2, dept: 'Sales', avgRating: '4.5/5', completed: 20, pending: 0 },
  { id: 3, dept: 'HR', avgRating: '3.9/5', completed: 5, pending: 1 }
];
      ...
      <LinearGradient colors={['#1E293B', '#0F172A']} style={styles.headerGradient}>
        <View style={styles.headerContent}>
          <View>
            ...
            <Text style={styles.headerSubtitle}>Monitor appraisals & ratings</Text>
          </View>
        ...
        <View style={styles.kpiRow}>
          <View style={styles.kpiCardFull}>
            <View style={styles.kpiRowHeader}>
              <Text style={styles.kpiLabel}>Company Avg Rating</Text>
              <Star size={16} color="#2563EB" />
            </View>
            <Text style={styles.kpiValueLarge}>4.2 <Text style={styles.kpiLabel}>/ 5</Text></Text>
          </View>
        </View>

        <View style={styles.kpiRow}>
          {renderKpi('Top Performers', '15%', TrendingUp, '#10B981', '#D1FAE5')}
          {renderKpi('Completed', '96%', Target, '#F59E0B', '#FEF3C7')}
        </View>
        
        <View style={styles.kpiRow}>
          {renderKpi('Needs Impr.', '4%', TrendingDown, '#EF4444', '#FEE2E2')}
          {renderKpi('Goals Met', '78%', Target, '#6366F1', '#E0E7FF')}
        </View>
          ...
          {SUMMARY_DATA.map(item => (
            <View key={item.id} style={styles.summaryCard}>
              <View style={styles.summaryHeader}>
                ...
                <Text style={styles.summaryTotal}>{item.avgRating}</Text>
              </View>
