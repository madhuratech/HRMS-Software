...
export default function HelpDeskReportsScreen({ navigation }) {
    ...
    <View style={styles.container}>
      <LinearGradient colors={['#1E293B', '#0F172A']} style={styles.headerGradient}>
        <View style={styles.headerContent}>
          <Text style={styles.headerTitle}>HelpDeskReports</Text>
        ...
        <View style={styles.searchContainer}>
          ...
          <Text style={styles.searchPlaceholder}>Search in HelpDeskReports...</Text>
        </View>
      </LinearGradient>
